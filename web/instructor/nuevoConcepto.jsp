...
<%
    ...
    String termino = request.getParameter("termino") != null
            ? request.getParameter("termino")
            : "";

    String definicion = request.getParameter("definicion") != null
...
<div class="container dashboard-container">
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <p class="lead mb-4">
                Agrega un término y su definición
            </p>

            <div class="form-container">

                <form action="guardarConcepto.jsp"
                      method="post"
                      id="formConcepto">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text"
                               ...
                               maxlength="100"
                               value="<%= termino %>"
                               placeholder="Ejemplo: Prompt Engineering">
                    ...
                    <div class="form-group mt-4">
                        ...
                        <textarea name="definicion"
                                  ...
                                  maxlength="3000"
                                  rows="6"
                                  placeholder="Escribe aquí la explicación del concepto..."><%= definicion %></textarea>
