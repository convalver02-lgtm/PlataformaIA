<%-- 
    Document   : nuevoConcepto
    Created on : 12/01/2026, 08:56:17 PM
    Author     : 16003
--%>
...
<html>
<head>
    <title>Nuevo Concepto - Diccionario IA</title>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="container dashboard-container">
        <div class="row">
            ...
            <!-- Formulario -->
            <div class="col-md-9">
                <h2 class="title">Crear Nuevo Concepto</h2>
                <p class="lead mb-4">Agrega un término y su definición al diccionario de IA</p>

                <div class="form-container">
                    <form action="guardarConcepto.jsp" method="post">
                        <div class="form-group">
                            <label for="termino" class="form-label">Término / Concepto</label>
                            <input type="text" name="termino" id="termino" class="form-control input" required placeholder="Ej: Prompt Engineering">
                        </div>

                        <div class="form-group mt-4">
                            <label for="definicion" class="form-label">Definición</label>
                            <textarea name="definicion" id="definicion" class="form-control input" rows="6" required placeholder="Escribe aquí la explicación clara y completa del concepto..."></textarea>
                        </div>
